...
```
#can save different style sheets this way and then change the style sheet at the csl up above. methods in ecology
...
f = open("/path/to/file")
lines = f.readlines() 
## can just save the graphs in python as a png and use markdown to import the graph that you made.
